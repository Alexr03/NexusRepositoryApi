...
${nuget_cmd} install src/SonaTypeNexusRepoApi/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/SonaTypeNexusRepoApi.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/SonaTypeNexusRepoApi.dll \
-recurse:'src/SonaTypeNexusRepoApi/*.cs' \
-doc:bin/SonaTypeNexusRepoApi.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/SonaTypeNexusRepoApi.dll was created successfully"
fi
