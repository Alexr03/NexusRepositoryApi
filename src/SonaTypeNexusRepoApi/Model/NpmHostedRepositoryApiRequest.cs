...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NpmHostedRepositoryApiRequest :  IEquatable<NpmHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public NpmHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
