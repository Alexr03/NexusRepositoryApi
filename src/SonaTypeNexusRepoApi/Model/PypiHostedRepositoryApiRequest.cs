...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PypiHostedRepositoryApiRequest :  IEquatable<PypiHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PypiHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
