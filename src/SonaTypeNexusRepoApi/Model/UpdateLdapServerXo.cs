...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateLdapServerXo :  IEquatable<UpdateLdapServerXo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            // ConnectionTimeoutSeconds (int?) maximum
            if(this.ConnectionTimeoutSeconds > (int?)3600)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ConnectionTimeoutSeconds, must be a value less than or equal to 3600.", new [] { "ConnectionTimeoutSeconds" });
            }

            // ConnectionTimeoutSeconds (int?) minimum
            if(this.ConnectionTimeoutSeconds < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ConnectionTimeoutSeconds, must be a value greater than or equal to 1.", new [] { "ConnectionTimeoutSeconds" });
            }

            // ConnectionRetryDelaySeconds (int?) minimum
            if(this.ConnectionRetryDelaySeconds < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for ConnectionRetryDelaySeconds, must be a value greater than or equal to 0.", new [] { "ConnectionRetryDelaySeconds" });
            }

            // MaxIncidentsCount (int?) minimum
            if(this.MaxIncidentsCount < (int?)0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for MaxIncidentsCount, must be a value greater than or equal to 0.", new [] { "MaxIncidentsCount" });
            }

            // GroupObjectClass (string) maxLength
            if(this.GroupObjectClass != null && this.GroupObjectClass.Length > 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupObjectClass, length must be less than 0.", new [] { "GroupObjectClass" });
            }

            // GroupObjectClass (string) minLength
            if(this.GroupObjectClass != null && this.GroupObjectClass.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupObjectClass, length must be greater than 0.", new [] { "GroupObjectClass" });
            }

            // GroupIdAttribute (string) maxLength
            if(this.GroupIdAttribute != null && this.GroupIdAttribute.Length > 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupIdAttribute, length must be less than 0.", new [] { "GroupIdAttribute" });
            }

            // GroupIdAttribute (string) minLength
            if(this.GroupIdAttribute != null && this.GroupIdAttribute.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupIdAttribute, length must be greater than 0.", new [] { "GroupIdAttribute" });
            }

            // GroupMemberAttribute (string) maxLength
            if(this.GroupMemberAttribute != null && this.GroupMemberAttribute.Length > 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupMemberAttribute, length must be less than 0.", new [] { "GroupMemberAttribute" });
            }

            // GroupMemberAttribute (string) minLength
            if(this.GroupMemberAttribute != null && this.GroupMemberAttribute.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupMemberAttribute, length must be greater than 0.", new [] { "GroupMemberAttribute" });
            }

            // GroupMemberFormat (string) maxLength
            if(this.GroupMemberFormat != null && this.GroupMemberFormat.Length > 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupMemberFormat, length must be less than 0.", new [] { "GroupMemberFormat" });
            }

            // GroupMemberFormat (string) minLength
            if(this.GroupMemberFormat != null && this.GroupMemberFormat.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for GroupMemberFormat, length must be greater than 0.", new [] { "GroupMemberFormat" });
            }

            // UserMemberOfAttribute (string) maxLength
            if(this.UserMemberOfAttribute != null && this.UserMemberOfAttribute.Length > 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UserMemberOfAttribute, length must be less than 0.", new [] { "UserMemberOfAttribute" });
            }

            // UserMemberOfAttribute (string) minLength
            if(this.UserMemberOfAttribute != null && this.UserMemberOfAttribute.Length < 0)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for UserMemberOfAttribute, length must be greater than 0.", new [] { "UserMemberOfAttribute" });
            }
