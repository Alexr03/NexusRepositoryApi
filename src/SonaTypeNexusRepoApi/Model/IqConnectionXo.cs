...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IqConnectionXo :  IEquatable<IqConnectionXo>, IValidatableObject
    {
        /// <summary>
        ...
        {
            // TimeoutSeconds (int?) maximum
            if(this.TimeoutSeconds > (int?)3600)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeoutSeconds, must be a value less than or equal to 3600.", new [] { "TimeoutSeconds" });
            }

            // TimeoutSeconds (int?) minimum
            if(this.TimeoutSeconds < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for TimeoutSeconds, must be a value greater than or equal to 1.", new [] { "TimeoutSeconds" });
            }
