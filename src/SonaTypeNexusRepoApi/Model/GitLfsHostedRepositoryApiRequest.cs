...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GitLfsHostedRepositoryApiRequest :  IEquatable<GitLfsHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public GitLfsHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
