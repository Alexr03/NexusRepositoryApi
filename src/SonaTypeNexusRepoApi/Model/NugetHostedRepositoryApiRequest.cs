...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NugetHostedRepositoryApiRequest :  IEquatable<NugetHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public NugetHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
