...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RHostedRepositoryApiRequest :  IEquatable<RHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
