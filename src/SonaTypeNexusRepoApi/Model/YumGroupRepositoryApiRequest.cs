...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class YumGroupRepositoryApiRequest :  IEquatable<YumGroupRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public YumGroupRepositoryApiRequest(string name = default(string), bool? online = default(bool?), StorageAttributes storage = default(StorageAttributes), GroupAttributes group = default(GroupAttributes))
        {
