...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BowerHostedRepositoryApiRequest :  IEquatable<BowerHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public BowerHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
