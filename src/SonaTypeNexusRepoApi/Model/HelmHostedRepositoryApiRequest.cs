...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HelmHostedRepositoryApiRequest :  IEquatable<HelmHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public HelmHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
