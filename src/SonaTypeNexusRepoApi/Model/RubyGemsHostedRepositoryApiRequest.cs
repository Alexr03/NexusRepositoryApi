...
namespace SonaTypeNexusRepoApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RubyGemsHostedRepositoryApiRequest :  IEquatable<RubyGemsHostedRepositoryApiRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public RubyGemsHostedRepositoryApiRequest(string name = default(string), bool? online = default(bool?), HostedStorageAttributes storage = default(HostedStorageAttributes), CleanupPolicyAttributes cleanup = default(CleanupPolicyAttributes))
        {
