...
namespace SonaTypeNexusRepoApi.Api
{
    ...
    public interface IFormatsApi : IApiAccessor
    {
        ...
        ApiResponse<UploadDefinitionXO> Get1WithHttpInfo (string format);
        /// <summary>
        ...
        ApiResponse<List<UploadDefinitionXO>> Get2WithHttpInfo ();
        ...
        System.Threading.Tasks.Task<UploadDefinitionXO> Get1Async (string format);
        ...
        System.Threading.Tasks.Task<ApiResponse<UploadDefinitionXO>> Get1AsyncWithHttpInfo (string format);
        /// <summary>
        /// Get upload field requirements for each supported format
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<UploadDefinitionXO>> Get2Async ();
        ...
        System.Threading.Tasks.Task<ApiResponse<List<UploadDefinitionXO>>> Get2AsyncWithHttpInfo ();
    ...
    public partial class FormatsApi : IFormatsApi
    {
        ...
        /// <returns></returns>
        public FormatsApi(SonaTypeNexusRepoApi.Client.Configuration configuration = null)
        {
        ...
        /// <param name="format">The desired repository format</param>
        /// <returns>UploadDefinitionXO</returns>
        public UploadDefinitionXO Get1 (string format)
        {
             ApiResponse<UploadDefinitionXO> localVarResponse = Get1WithHttpInfo(format);
        ...
        /// <param name="format">The desired repository format</param>
        /// <returns>ApiResponse of UploadDefinitionXO</returns>
        public ApiResponse< UploadDefinitionXO > Get1WithHttpInfo (string format)
        {
            // verify the required parameter 'format' is set
            if (format == null)
                throw new ApiException(400, "Missing required parameter 'format' when calling FormatsApi->Get1");
        ...
        /// <param name="format">The desired repository format</param>
        /// <returns>Task of UploadDefinitionXO</returns>
        public async System.Threading.Tasks.Task<UploadDefinitionXO> Get1Async (string format)
        {
             ApiResponse<UploadDefinitionXO> localVarResponse = await Get1AsyncWithHttpInfo(format);
             return localVarResponse.Data;
        ...
        /// <param name="format">The desired repository format</param>
        /// <returns>Task of ApiResponse (UploadDefinitionXO)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UploadDefinitionXO>> Get1AsyncWithHttpInfo (string format)
        {
            // verify the required parameter 'format' is set
            if (format == null)
                throw new ApiException(400, "Missing required parameter 'format' when calling FormatsApi->Get1");
        ...
        /// <exception cref="SonaTypeNexusRepoApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>List&lt;UploadDefinitionXO&gt;</returns>
        public List<UploadDefinitionXO> Get2 ()
        {
             ApiResponse<List<UploadDefinitionXO>> localVarResponse = Get2WithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="SonaTypeNexusRepoApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;UploadDefinitionXO&gt;</returns>
        public ApiResponse< List<UploadDefinitionXO> > Get2WithHttpInfo ()
        {
        ...
        /// <exception cref="SonaTypeNexusRepoApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of List&lt;UploadDefinitionXO&gt;</returns>
        public async System.Threading.Tasks.Task<List<UploadDefinitionXO>> Get2Async ()
        {
             ApiResponse<List<UploadDefinitionXO>> localVarResponse = await Get2AsyncWithHttpInfo();
             return localVarResponse.Data;
        ...
        /// <exception cref="SonaTypeNexusRepoApi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>Task of ApiResponse (List&lt;UploadDefinitionXO&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<UploadDefinitionXO>>> Get2AsyncWithHttpInfo ()
        {
